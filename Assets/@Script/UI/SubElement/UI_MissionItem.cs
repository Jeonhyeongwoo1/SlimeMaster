...
{
    public class UI_MissionItem : UI_SubItemElement
    {
            ...
            int missionTargetValue, bool isCompleted, bool isGetReward)
        {
            ...
            _getButton.SafeAddButtonListener(onGetMissionReward.Invoke);   
